package com.smartcity.resources_crud.listener.achievement;
...
public class AchievementExcelListener extends AnalysisEventListener<AchievementData> {
    ...
    public ResourceService<SmartcityAchievement> achievementService;

    public AchievementExcelListener(){}
    public AchievementExcelListener(ResourceService<SmartcityAchievement> service){
    ...
    //判断成果标题是否唯一，避免重复添加
    private SmartcityAchievement existAchievement(ResourceService<SmartcityAchievement> service, String kgId){
