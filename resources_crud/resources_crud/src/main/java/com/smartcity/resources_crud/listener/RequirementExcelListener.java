...
public class RequirementExcelListener extends AnalysisEventListener<RequirementData> {
    ...
    public ResourceService<SmartcityRequirement> requirementService;

    public RequirementExcelListener(){}
    public RequirementExcelListener(ResourceService<SmartcityRequirement> service){
    ...
    //判断KG_id是否唯一，不能重复添加
    private SmartcityRequirement existRequirement(ResourceService<SmartcityRequirement> service, String id){
