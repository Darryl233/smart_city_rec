...
public class SolutionExcelListener extends AnalysisEventListener<SolutionData> {
    public ResourceService<SmartcitySolution> solutionService;

    public SolutionExcelListener(){}
    public SolutionExcelListener(ResourceService<SmartcitySolution> service){
    ...
    //判断KG_id是否唯一，不能重复添加
    private SmartcitySolution existSolution(ResourceService<SmartcitySolution> service, String id){
