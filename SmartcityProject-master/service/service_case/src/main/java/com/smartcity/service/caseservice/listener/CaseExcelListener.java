package com.smartcity.service.caseservice.listener;
...
public class CaseExcelListener extends AnalysisEventListener<CaseData> {
    public SmartcityCaseService caseService;

    public CaseExcelListener(){}
    public CaseExcelListener(SmartcityCaseService service){
    ...
    //判断KG_id是否唯一，不能重复添加
    private SmartcityCase existCase(SmartcityCaseService service, String id){
