package com.smartcity.service.paperservice.listener;
...
public class PaperExcelListener extends AnalysisEventListener<PaperData> {
    ...
    public SmartcityPaperService paperService;

    //无参和有参构造Listener，实现paperService注入
    public PaperExcelListener(){}
    public PaperExcelListener(SmartcityPaperService paperService){
    ...
    //判断论文标题是否唯一，不能重复添加
    private SmartcityPaper existPaper(SmartcityPaperService service, String kgId){
