...
import com.smartcity.service.ucenter.util.ConstantPropertiesUtil;
import com.smartcity.service.ucenter.util.HttpClientUtils;
...
public class WxApiController {
    ...
    public String callback(String code, String state){
        ...
        Member member = null;//memberService.getByOpenid(openid);
        if(member == null){
